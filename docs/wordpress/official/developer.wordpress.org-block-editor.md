[Skip to content](https://developer.wordpress.org/block-editor/#wp--skip-link--target)
...
- [Navigating this handbook](https://developer.wordpress.org/block-editor/#navigating-this-handbook)
- [Further resources](https://developer.wordpress.org/block-editor/#further-resources)
- [Are you in the right place?](https://developer.wordpress.org/block-editor/#are-you-in-the-right-place)

[↑ Back to top](https://developer.wordpress.org/block-editor/#wp--skip-link--target)
...
![Quick view of the Block Editor](https://i0.wp.com/developer.wordpress.org/files/2026/06/overview-block-editor-2023-scaled.png?ssl=1)
...
[Improve it on GitHub: Block Editor Handbook](https://github.com/WordPress/gutenberg/edit/trunk/docs/README.md)
