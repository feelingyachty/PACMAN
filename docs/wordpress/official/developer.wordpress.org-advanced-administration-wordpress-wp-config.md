[Skip to content](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp--skip-link--target)
...
[Home](https://developer.wordpress.org/)[Advanced Administration Handbook](https://developer.wordpress.org/advanced-administration/)[WordPress configuration](https://developer.wordpress.org/advanced-administration/wordpress/)Editing wp-config.php
...
- [wp-config.php](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp-config-php)
  - [Advanced Options](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#advanced-options)
    - [table\_prefix](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#table-prefix)
    - [WP\_SITEURL](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp-siteurl)
    - [Blog address (URL)](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#blog-address-url)
    - [Moving wp-content folder](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#moving-wp-content-folder)
    - [Moving plugin folder](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#moving-plugin-folder)
    - [Moving themes folder](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#moving-themes-folder)
    - [Moving uploads folder](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#moving-uploads-folder)
    - [Modify AutoSave Interval](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#modify-autosave-interval)
    - [Post Revisions](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#post-revisions)
    - [Set Cookie Domain](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#set-cookie-domain)
    - [Enable Multisite / Network Ability](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#enable-multisite-network-ability)
    - [Redirect Nonexistent Blogs](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#redirect-nonexistent-blogs)
    - [Fatal Error Handler](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp-disable-fatal-error-handler)
    - [WP\_DEBUG](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp-debug)
    - [WP\_ENVIRONMENT\_TYPE](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp-environment-type)
    - [SCRIPT\_DEBUG](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#script-debug)
    - [Disable Javascript Concatenation](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-javascript-concatenation)
    - [Configure Error Logging](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#configure-error-logging)
    - [Increasing memory allocated to PHP](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#increasing-memory-allocated-to-php)
    - [Cache](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#cache)
    - [Custom User and Usermeta Tables](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#custom-user-and-usermeta-tables)
    - [Language and Language Directory](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#language-and-language-directory)
    - [Save queries for analysis](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#save-queries-for-analysis)
    - [Override of default file permissions](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#override-of-default-file-permissions)
    - [WordPress Upgrade Constants](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wordpress-upgrade-constants)
    - [Alternative Cron](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#alternative-cron)
    - [Disable Cron and Cron Timeout](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-cron-and-cron-timeout)
    - [Additional Defined Constants](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#additional-defined-constants)
    - [Empty Trash](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#empty-trash)
    - [Automatic Database Optimizing](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#automatic-database-optimizing)
    - [DO\_NOT\_UPGRADE\_GLOBAL\_TABLES](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#do-not-upgrade-global-tables)
    - [View All Defined Constants](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#view-all-defined-constants)
    - [Disable the Plugin and Theme File Editor](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-the-plugin-and-theme-file-editor)
    - [Disable Plugin and Theme Update and Installation](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-plugin-and-theme-update-and-installation)
    - [Require SSL for Admin and Logins](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#require-ssl-for-admin-and-logins)
    - [Block External URL Requests](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#block-external-url-requests)
    - [Disable WordPress Auto Updates](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-wordpress-auto-updates)
    - [Disable WordPress Core Updates](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#disable-wordpress-core-updates)
    - [Cleanup Image Edits](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#cleanup-image-edits)
  - [Double Check Before Saving](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#double-check-before-saving)

[↑ Back to top](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/#wp--skip-link--target)
...
#### [Disable Post Revisions](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/\#disable-post-revisions)
...
#### [Specify the Number of Post Revisions](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/\#specify-the-number-of-post-revisions)
...
The [WP\_DEBUG](https://developer.wordpress.org/advanced-administration/debug/debug-wordpress/) option controls the reporting of some errors and warnings and enables use of the WP\_DEBUG\_DISPLAY and WP\_DEBUG\_LOG settings. The default boolean value is false.
...
[Database errors are printed only if WP\_DEBUG is set to true](https://trac.wordpress.org/ticket/5473). Database errors are handled by the [wpdb](https://developer.wordpress.org/reference/classes/wpdb/) class and are not affected by [PHP’s error settings](https://www.php.net/errorfunc).
...
#### [WordPress v3.9.6 and below](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/\#wordpress-v3-9-6-and-below)
...
#### [Enabling SSH Upgrade Access](https://developer.wordpress.org/advanced-administration/wordpress/wp-config/\#enabling-ssh-upgrade-access)
...
FORCE\_SSL\_ADMIN is for when you want to secure logins and the admin area so that both passwords and cookies are never sent in the clear. See also [HTTPS](https://developer.wordpress.org/advanced-administration/security/https/) for more details.
...
[Improve it on GitHub: Editing wp-config.php](https://github.com/WordPress/Advanced-administration-handbook/edit/main/wordpress/wp-config.md)

Changelog

[See list of changes: Editing wp-config.php](https://github.com/WordPress/Advanced-administration-handbook/commits/main/wordpress/wp-config.md)

[PreviousWordPress configurationPrevious: WordPress configuration](https://developer.wordpress.org/advanced-administration/wordpress/)

[NextSite Architecture (v1.5)Next: Site Architecture (v1.5)](https://developer.wordpress.org/advanced-administration/wordpress/site-architecture/)
