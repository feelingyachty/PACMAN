...
export const seedStore: StoreData = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description:
        "n8n-mcp is authorized. Pacman watches the instance. New agents are added only when the owner introduces them.",
      agentId: "pacman",
      assignedBy: "owner",
      status: "working",
      priority: "medium",
  ...
  logs: [
    ...
    },
    {
      ...
      body: "MCP authorized. Official n8n MCP Server (34 tools). New agents are added only when the owner introduces them.",
    },
  ],
  knowledge: [],
  automations: [],
  ...
  activity: [
    ...
    },
    {
      ...
      type: "agent_added",
      message:
        "Pacman connected n8n-mcp. Roster stays Pacman + Corey until new agents are introduced.",
      agentId: "pacman",
    },
  ],
};
